<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fransizca_sozler.aspx.cs" Inherits="renkler" %>
                ...
                <ItemTemplate>
                    <table style="width:100%; margin-bottom: 7px; ">
                        <tr>
                            ...
                            <td class="style8">
                                <asp:Label ID="Label7" runat="server" Text='<%# Eval("soz_fransizca").ToString() %>'></asp:Label>
                            </td>
                        </tr>
                    </table>
                </ItemTemplate>
